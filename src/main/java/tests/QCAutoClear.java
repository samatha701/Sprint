...
public class QCAutoClear extends QCStore{
	public static void autoClear(String SSN,String AppURL) throws Exception
	{
		try{
			...
			String screenshotPath = getScreenhot(driver, "AutoClear");
