...
public class AfterEditLoan_LoanApproved extends LendNation {

	/*public static void afteredit_loanapproved(String SSN,String AppURL,String loan_number) throws Exception
...
/*		else 
	...
	
	{
		...
		//loan_number="10788332";
					...
					String Approved_Loan = driver.findElement(By.name("requestBean.appLoanAmount")).getAttribute("value");
					test.log(LogStatus.PASS, "Approved Loan Amount Changed To : " +Approved_Loan);
