...
public class RQCCSRWriteOff extends QCStore {
	public static void writeoff(String SSN, String AppURL) throws InterruptedException {
		...
		// -----------------------------------
						...
						driver.switchTo().defaultContent();
						driver.switchTo().frame("mainFrame");
						wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("903000")));
						driver.findElement(By.id("903000")).click();
		...
		//Admin Login For Getting Encryption Key
						...
						QCAdminEncryption.getEncryptionForWriteOff(driver,SSN, AppURL);
						 Thread.sleep(5000);
						 driver.switchTo().defaultContent();
						 driver.switchTo().frame("mainFrame");
						 driver.switchTo().frame("main");
