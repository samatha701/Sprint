						       ...
						       Thread.sleep(4000);
								...
								test.log(LogStatus.PASS, "Click on submit Button");		
								 ...
								 driver.findElement(By.name("button")).click();
									...
									loan_nbr=driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr[8]/td[2]/table/tbody/tr/td/table/tbody/tr[4]/td[3]")).getText();
